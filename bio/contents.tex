  ...
  \begin{block}{Var gick jag i skola?}
    \begin{description}
      ...
      \alert<5-6>{\item[Gymnasiet] Naturvetenskapliga programmet, Timrå 
        ...
        Finns många studenter på KTH som gått t.ex.~Estetiska programmet.
    }}
    \end{description}
  \end{block}

  \begin{figure}
    \only<1>{\includegraphics[height=0.5\textheight]{fig/laggarbergs-skola.png}}
    \only<2>{\includegraphics[height=0.5\textheight]{fig/laggarberg-close.png}}
    \only<3>{\includegraphics[height=0.5\textheight]{fig/mariedalsskolan.png}}
    \only<4>{\includegraphics[height=0.5\textheight]{fig/mariedal-laggarberg.png}}
    \only<5>{\includegraphics[height=0.5\textheight]{fig/tigy.png}}
    \only<6>{\includegraphics[height=0.5\textheight]{fig/tigy-map.png}}
    \only<1-2,4-6>{\includegraphics[height=0.5\textheight]{fig/laggarberg-sweden.png}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \only<1>{\includegraphics[height=0.4\textheight]{fig/miun.jpg}
    \includegraphics[height=0.4\textheight]{fig/miun-map.png}}
    \only<2-3>{\includegraphics[height=0.4\textheight]{fig/kth.jpg}
    \includegraphics[height=0.4\textheight]{fig/kth-map.png}}
    \only<4>{\includegraphics[height=0.4\textheight]{fig/inria-rennes.jpg}
